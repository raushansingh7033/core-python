...
# num2=50,num3=89,num4=85 #error we can't intialize multiple variables like this
num2,num3,num4=56,67,89

print("num2=",num2)
print("num3=",num3)
print("num4=",num4)

print("num2=",num2,"num3=",num3,"num4=",num4)
print("num2="+str(num2)+" num3="+str(num3)+" num4="+str(num4))